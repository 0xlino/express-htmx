export function footer(){
    return `<footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
    <div class="grid grid-flow-col gap-4">
      <a class="link link-hover" href="https://benline.co.uk" target="_blank">
        Ben Line
      </a>
    </div>

    <div class="grid grid-flow-col gap-4">
      <a href="https://github.com/0xlino" target="_blank">
